...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    private Button ResetPasswordSendButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ResetPasswordSendButton = (Button) findViewById(R.id.reset_password_email_button);
                    ...
                    mAuth.sendPasswordResetEmail(userEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()){
                                Toast.makeText(ResetPasswordActivity.this, "Check Your Email Address...", Toast.LENGTH_SHORT).show();
