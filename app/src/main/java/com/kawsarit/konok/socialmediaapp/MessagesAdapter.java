    ...
    public void onBindViewHolder(@NonNull final MessagesAdapter.MessageViewHolder holder, int position) {
        ...
        if (fromMessageType.equals("text")){
            ...
            if (fromUserID.equals(messageSenderID)){
                ...
                holder.SenderMessageText.setBackgroundResource(R.drawable.sender_message_text_color);
                ...
                holder.ReceiverMessageText.setBackgroundResource(R.drawable.receiver_message_text_color);
